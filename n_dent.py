...
for i in range(1):
	...
	sph1_placement_x = random.randint(62,800)
	sph1_placement_y = random.randint(62,240)
	sph_obj1.Placement = App.Placement(App.Vector(sph1_placement_x,sph1_placement_y,0),App.Rotation(App.Vector(0,0,0),0))    # sph2_rad = random.randint(5,15)
	sph_obj1.Angle2 = 0 # For Bump
	add_obj = doc.addObject("Part::Fuse","fusion1")
	add_obj.Base = doc.Box
	...
	__fillets__ = []
	__fillets__.append((13,1.00,1.00)) # 13 is edge where fillet is created
